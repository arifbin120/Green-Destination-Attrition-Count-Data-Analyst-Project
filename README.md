...
**Live Dashboard:** [Tableau Public – Green Destination HR Department](https://public.tableau.com/views/GREENDESTINATIONHRDEPARTMENT/Dashboard1?:language=en-US&publish=yes&:sid=&:redirect=auth&:display_count=n&:origin=viz_share_link)
...
1. Determine the **attrition rate** (% of employees who have left).
2. Identify whether factors such as **age, years at the company, and income** influence attrition.
